...
export const config = {
  api: {
    ...
    me: hostApi + '/api/me/',
    member: {
      list: hostApi + '/api/members/',
      quick_list: hostApi + '/api/members/quick-list/',
      detail: hostApi + '/api/members/%s/',
      history: hostApi + '/api/members/%s/history/',
      salesperson: hostApi + '/api/members/%s/salesperson/',
      organizations: hostApi + '/api/members/%s/organizations/',
    },
    salesperson: {
      list: hostApi + '/api/salesperson/',
    },
    salesperson_period: {
      list: hostApi + '/api/salesperson-period/',
      detail: hostApi + '/api/salesperson-period/%s/',
    },
    organization_period: {
      list: hostApi + '/api/organization-period/',
      detail: hostApi + '/api/organization-period/%s/',
    },
    organization: {
      list: hostApi + '/api/organizations',
      quick_list: hostApi + '/api/organizations/quick-list/',
      detail: hostApi + '/api/organizations/%s/',
      members: hostApi + '/api/organizations/%s/members/',
      positions: hostApi + '/api/organizations/%s/positions/',
    },
    position_ship: {
      list: hostApi + '/api/position-ship/',
      detail: hostApi + '/api/position-ship/%s/',
    },
